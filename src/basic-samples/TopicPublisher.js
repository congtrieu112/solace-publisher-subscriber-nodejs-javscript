...
var TopicPublisher = function(solaceModule, topicName) {
  ...
  publisher.connect = function(argv) {
    ...
    publisher.session.on(solace.SessionEventCode.CONNECT_FAILED_ERROR, function(
      sessionEvent
    ) {
      publisher.log(
  ...
  publisher.publish = function(msg = "Sample Message", topPic = null) {
    if (publisher.session !== null) {
      var messageText = msg;
      var message = solace.SolclientFactory.createMessage();
      var topPicName = topPic ? topPic : publisher.topicName;
      message.setDestination(
        solace.SolclientFactory.createTopicDestination(topPicName)
      );
